...
Route::post('forgot_post', [AdminController::class, 'AdminForgot'])->name('admin.forgot');
Route::get('reset/admin/{token}', [AdminController::class, 'AdminReset'])->name('admin.reset');
Route::post('reset_post/{token}', [AdminController::class, 'postAdminReset'])->name('admin.reset.post');
...
Route::controller(OrderController::class)->group(function(){
    ...
    Route::get('/admin/order/cancel/{order_id}' , 'AdminOrderCancel')->name('admin.order.cancel');
