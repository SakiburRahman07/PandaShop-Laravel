...
$setting = App\Models\SiteSetting::find(1);
 ...
 <footer class="main">
   ...
   <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo ) }}" alt="logo" /></a>
                                <p class="font-lg text-heading">Largest Ecommerce Website in Bangladesh</p>
                            </div>
    ...
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span></li>
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            ...
                            <li><a href="{{route('compare')}}">My Compare</a></li>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2024, <strong class="text-brand">PandaShop</strong> -  {{ $setting->copyright }}</p>
                </div>
