 ...
 <script type="text/javascript">
    ...
    function addToCart(){
     ...
     $.ajax({
        ...
        dataType : 'json',
        data:{
            color:color, size:size, quantity:quantity,product_name:product_name,vendor_id:vendor
        },
           ...
           miniCart += ` <ul>
            <li>
                <div class="shopping-cart-img">
                    <a href="shop-product-right.html"><img alt="Nest" src="/${value.product.product_thambnail} " style="width:50px;height:50px;" /></a>
                </div>
    ...
    $.ajax({
        ...
        $.each(response.carts, function(key,value){
           rows += `<tr class="pt-30">
            ...
            <td class="image product-thumbnail pt-40"><img src="/${value.product.product_thambnail} " alt="#"></td>
            <td class="product-des product-name">
                <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">${value.product.product_name} </a></h6>
