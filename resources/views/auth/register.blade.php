...
<head>
    <meta charset="utf-8" />
    <title>Register - PandaShop </title>
...
<body>
   ...
   @include('frontend.body.header')
    ...
    <div class="form-group">
        <input type="text" id="name" name="name" placeholder="Username" required value="{{ old('name') }}" />
        @error('name')
    ...
    {{-- Checkbox for terms and conditions --}}
        ...
        <div class="custome-checkbox">
            <input class="form-check-input" type="checkbox" name="checkbox" id="checkbox" value="1" {{ old('checkbox') ? 'checked' : '' }} required />
            <label class="form-check-label" for="checkbox">I agree to terms & conditions.</label>
            @error('checkbox')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
