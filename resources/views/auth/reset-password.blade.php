                    ...
                    <div class="col-xl-6 col-lg-8 col-md-12 m-auto">
                        <div class="row">
                            <div class="heading_s1">
                                ...
                                <p class="mb-30">After reseting you can log in with new password.</p>
                            </div>
        ...
        <div class="padding_eight_all bg-white">
            ...
            <input type="hidden" name="token" value="{{ $request->route('token') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" required="" name="email" value="{{$request->email}}" placeholder="Email *" />
                </div>
                ...
                <div class="form-group">
                    <input type="password" id="password_confirmation" required="" name="password_confirmation" placeholder="Confirm Password *" />
                </div>
